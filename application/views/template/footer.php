					...
					<div class="col-lg-6 col-md-12 col-sm-12 col-12">
						...
						<div class="row pt-3">
							...
							<div class="col-lg-10 col-md-9 col-sm-9 col-9">
								...
								<p>085771522432 a/n Ryan D Masiv</p>
							</div>
						</div>
						<div class="row pt-3">
							<div class="col-lg-1 offset-1 col-md-2 col-sm-2 col-2">
							...
							<div class="col-lg-10 col-md-9 col-sm-9 col-9">
								...
								<p><a style="color: #000000;" href="https://www.instagram.com/adekurniaw4n/?hl=id">Griya Loka</a></p>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-12 col-sm-12 col-12">
						<form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('contact/message'); ?>">
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label for="firstname">First Name</label>
										<input name="firstname" type="text" required="required" class="form-control" id="firstname">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input name="subject" type="text" required="required" class="form-control" id="subject">
									</div>
								</div>
								<div class="col-sm-12">
									<div class="form-group">
